...
const UserLocalModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'organizationIds': PropertySchema(
      id: 5,
      name: r'organizationIds',
...
int _userLocalModelEstimateSize(
  ...
  bytesCount += 3 + object.organizationIds.length * 3;
  {
    for (var i = 0; i < object.organizationIds.length; i++) {
      final value = object.organizationIds[i];
...
void _userLocalModelSerialize(
  ...
  writer.writeStringList(offsets[5], object.organizationIds);
...
UserLocalModel _userLocalModelDeserialize(
  ...
  object.isarId = id;
  object.organizationIds = reader.readStringList(offsets[5]) ?? [];
...
extension UserLocalModelQueryFilter
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      organizationIdsElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'organizationIds',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      organizationIdsElementGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      organizationIdsElementLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      organizationIdsElementStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      organizationIdsElementEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      organizationIdsElementContains(String value,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'organizationIds',
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      organizationIdsElementMatches(String pattern,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'organizationIds',
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      organizationIdsElementIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'organizationIds',
        value: '',
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      organizationIdsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterFilterCondition>
      organizationIdsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension UserLocalModelQuerySortBy
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy> sortByCountry() {
    return QueryBuilder.apply(this, (query) {
...
extension UserLocalModelQuerySortThenBy
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QAfterSortBy> thenByCountry() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'country', Sort.asc);
    });
  }
...
extension UserLocalModelQueryWhereDistinct
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QDistinct> distinctByCountry(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, UserLocalModel, QDistinct>
      distinctByOrganizationIds() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'organizationIds');
    });
  }
...
extension UserLocalModelQueryProperty
  ...
  QueryBuilder<UserLocalModel, String?, QQueryOperations> countryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocalModel, List<String>, QQueryOperations>
      organizationIdsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'organizationIds');
    });
  }
