...
extension SyncQueueModelQueryWhereSort
  ...
  QueryBuilder<SyncQueueModel, SyncQueueModel, QAfterWhere> anyIsarId() {
...
extension SyncQueueModelQueryWhere
  ...
  QueryBuilder<SyncQueueModel, SyncQueueModel, QAfterWhereClause> isarIdEqualTo(
      Id isarId) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<SyncQueueModel, SyncQueueModel, QAfterWhereClause> isarIdBetween(
    Id lowerIsarId,
    Id upperIsarId, {
...
extension SyncQueueModelQueryProperty
  ...
  QueryBuilder<SyncQueueModel, String, QQueryOperations> entityTypeProperty() {
    return QueryBuilder.apply(this, (query) {
